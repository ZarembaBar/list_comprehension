from list_comprehension_exercises import (
    all_numbers_form_one_to_thousand_divisible_by_seven,
...
def test_all_numbers_form_one_to_thousand_divisible_by_seven_happy_path():
    assert all_numbers_form_one_to_thousand_divisible_by_seven() == [
        7,
        14,
        21,
        28,
...
def test_all_numbers_form_one_to_thousand_with_three_in_them_happy_path():
    assert all_numbers_form_one_to_thousand_with_three_in_them() == [
        3,
        13,
        23,
        30,
...
def test_count_the_number_of_spaces_in_string_empty_string_case():
    assert count_the_number_of_spaces_in_string("") == 0
...
def test_list_all_consonants_in_sentence_happy_path():
    ...
    assert list_all_consonants_in_sentence(sentence) == [
        "Y",
        "l",
        "l",
        "w",
